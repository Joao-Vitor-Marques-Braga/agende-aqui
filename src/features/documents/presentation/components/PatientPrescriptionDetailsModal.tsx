...
interface PatientPrescriptionDetailsModalProps {
  isOpen: boolean
  onClose: () => void
  prescription: PatientPrescription | null
}

export function PatientPrescriptionDetailsModal({ isOpen, onClose, prescription }: PatientPrescriptionDetailsModalProps) {
        ...
        <div className="p-6">
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Informações do Médico</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700">Médico</label>
                  <p className="mt-1 text-sm text-gray-900">{prescription.doctorName}</p>
                </div>
                <div>
